...
| Panels | `panelRooms`, `pnSel`, `pnView`, `pnUid`, `pnLayoutMemo`, `pnVb`, `pnSnapGeo` | engine consts `PN_CAP`/`PN_CROSS`/`PN_SHK` |
...
- `panelRooms` — Panels mode rooms (additive; legacy panneling quotes import via `pnImportLegacy`).
